...
////////////////////////////////////////////////////////////////////////////////////////////////////
Window::Window(): mWindowFlags(0), mViewFlags(0), mWidth(0), mHeight(0), mBackgroundCoerced(false),
    ...
    bool emulateTouch)
{
    ...
    mCurrentClearColor = mClearColor;
...
void Window::Render(double time)
{
...

    {
        ...
        bool doClearColor = mBackgroundCoerced || hasDebugFlags;
...
bool Window::CoerceBackground(const DependencyObject* object, const void* in, void* out)
{
    ...
    if (clearColor != 0)
    {
        window->mClearColor = clearColor->GetColor();
        window->mBackgroundCoerced = true;

        // Set a transparent brush so Hit-Testing works on the Window
...
{
    if (NS_UNLIKELY(color != mCurrentClearColor))
    {
