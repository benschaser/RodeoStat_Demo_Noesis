...
////////////////////////////////////////////////////////////////////////////////////////////////////
static void OnResourcesChanged(DependencyObject* obj, const DependencyPropertyChangedEventArgs& args)
{
    const LocMonitor* monitor = obj->GetValue<Ptr<LocMonitor>>(MonitorProperty);
